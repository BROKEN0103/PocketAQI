...
export default {
  ...
  safelist: [
    "text-aqi-good", "text-aqi-moderate", "text-aqi-bad", "text-aqi-very-bad", "text-aqi-hazardous",
    "bg-aqi-good", "bg-aqi-moderate", "bg-aqi-bad", "bg-aqi-very-bad", "bg-aqi-hazardous",
